...
* Finally, before you begin, please remember to review the **safety guidelines** listed at the end of this tutorial and follow the recommendations mentioned therein.  
...
* This completes this introductory tutorial. From here on, if you would like to connect cables and electrodes and actuatlly stimulate a fake Zucchini muscle, then follow the setup instructions shown in our [April Update](https://www.crowdsupply.com/neuralaxy/neurostimduino/updates/tips-on-electrode-placement)
...
* We hope you enjoy tinkering with NeuroStimDuino and use it for all your neuroscience experiments. If you face any issue with the device or are stuck anytime, feel free to write to us on contactus@neuralaxy.com or submit an issue on the [github repository](https://github.com/neuralaxy/NeuroStimDuino). 
